...
export default function Homepage() {
  ...
  return (
    <Layout>
      {/* Hero Section */}
      <section className="min-h-[90vh] sm:min-h-[80vh] flex items-center justify-center bg-white dark:bg-background/90 py-10 sm:py-0">
      ...
      {/* Features Section */}
      <section className="py-20 bg-muted/90 dark:bg-muted/10">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">On/Off Ramping</h3>
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">Bill Payments</h3>
              <p className="text-black/70 dark:text-white/70">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">Automated Savings</h3>
              <p className="text-black/70 dark:text-white/70">
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-2 text-black dark:text-white">Security First</h3>
              <p className="text-black/70 dark:text-white/70">
      ...
      <section className="py-20 bg-white dark:bg-background/50">
        <div className="container mx-auto px-4 sm:px-6">
          <motion.div 
            className="max-w-4xl mx-auto bg-white dark:bg-background rounded-2xl p-8 md:p-12 shadow-xl border border-black/10 dark:border-white/10 relative overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
          >
            ...
            <div className="relative z-10">
              <h2 className="text-2xl md:text-3xl font-bold mb-4 text-center text-black dark:text-white">Ready to revolutionize your financial experience?</h2>
              <p className="text-black/70 dark:text-white/70 text-center mb-8">Join thousands on our waitlist to be among the first to experience Framp.</p>
